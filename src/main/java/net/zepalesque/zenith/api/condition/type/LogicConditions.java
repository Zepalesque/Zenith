...
public class LogicConditions {
    ...
    public record And<E extends Condition<?>, T extends Condition<?>>(E arg1, T arg2)
        ...
        public static final MapCodec<And<?, ?>> CODEC = RecordCodecBuilder.mapCodec(builder ->
                builder.group(Condition.ELEMENT_CODEC.fieldOf("arg1").forGetter(And::arg1),
                                Condition.ELEMENT_CODEC.fieldOf("arg2").forGetter(And::arg2))
                        .apply(builder, And::new));
    ...
    public record Not<E extends Condition<?>>(E condition)
        ...
        public static final MapCodec<Not<?>> CODEC = RecordCodecBuilder.mapCodec(builder ->
                builder.group(Condition.ELEMENT_CODEC.fieldOf("inverted").forGetter(Not::condition))
    ...
    public record Or<E extends Condition<?>, T extends Condition<?>>(E arg1, T arg2)
        ...
        public static final MapCodec<Or<?, ?>> CODEC = RecordCodecBuilder.mapCodec(builder ->
                builder.group(Condition.ELEMENT_CODEC.fieldOf("arg1").forGetter(Or::arg1),
                                Condition.ELEMENT_CODEC.fieldOf("arg2").forGetter(Or::arg2))
                        .apply(builder, Or::new));
