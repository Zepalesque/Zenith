...
public class ZenithFeatures {
    ...
    public static DeferredHolder<Feature<?>, Feature<RuleBasedLakeFeature.Config>> RULE_BASED_LAKE = FEATURES.register("rule_based_lake", () -> new RuleBasedLakeFeature(RuleBasedLakeFeature.Config.CODEC));
